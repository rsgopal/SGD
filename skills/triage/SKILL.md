...
- The current working directory's codebase structure, recent git history, and any planning artifacts (`CLAUDE.md`, `.planning/`) that describe the domain, technology, and constraints
